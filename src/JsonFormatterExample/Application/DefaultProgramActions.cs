...
namespace Application
{
    ...
    public class DefaultProgramActions : IProgramActions
    {
        ...
        /// <remarks>Will check for the existence of a file before the contents are read. Uses Newtonsoft.Json for JSON code.</remarks>
        ...
        /// </summary>
        /// <remarks>Reads the AuthorName and AuthorEmail keys from AppSettings.</remarks>
        public void About()
        {
